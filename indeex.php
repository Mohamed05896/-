  <?php
ob_start();
define('API_KEY','5707937750:AAHFOxBWBUF0p51wTGwDUfrHlgaPXNTHiiM');
$Ali = "6134522593";
$sudo = "6134522593";
$admin = "6134522593";
$bot_id = "5707937750";
...
$urls="https://freegg.ml/nizk";//http://vzhsbd.ml
//»»»»»»»»»»»»»»»»»»
...
[['text'=>'📬 المطور','url'=>'https://t.me/IlHll']],],])]);}
...
[['text'=>'🗑┊› قناة البوت الرسمية','url'=>'https://t.me/thtss']],
[['text'=>'🛠┊› كيف انشى بوت','callback_data'=>'help'],['text'=>'🖲┊› تحديث البوت', 'callback_data'=>"hkt"]],
[['text'=>'👨‍✈️┊› المطور الرسمي ','url'=>'https://t.me/IlHll']],],])]);}
if($data == 'home'){
bot('editMessageText',['chat_id'=>$chat_id2,'message_id'=>$message_id,'text'=>"*
👨‍✈️ ⁞ مرحبا بك *$name* ؛ 
📟 ⁞ في المصنع الرسمي لسورس النيزك ؛
...
"],
            'reply_markup'=>['inline_keyboard'=>[
                [
                ['text'=>"🛠 اصنع بوتك مجانا",'url'=>'https://telegram.me/$username?start']
               ], 
